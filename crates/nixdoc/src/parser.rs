...
use crate::{
  DocComment,
  error::{ParseError, ParseWarning, WarningKind},
  section::{Argument, Example, Section},
};
...
/// whitespace is detected across all non-empty lines and removed from each
/// line.
///
/// # Examples
///
...
pub fn normalize(content: &str) -> String {
  ...
  // whitespace such as U+00A0 (non-breaking space) or U+3000 (ideographic
  // space).
