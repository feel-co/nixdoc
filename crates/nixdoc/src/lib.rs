...
pub struct DocComment {
  /// The normalized comment body with delimiters stripped and indentation
  /// removed.
...
impl DocComment {
  ...
  /// Returns the full description. Description is the content before the first
  /// section heading.
  ///
  ...
  ///    Type` section.
  /// 2. **Legacy format**: an `identifier :: type` annotation embedded directly
  ///    in the description text, without a `# Type` section.
  ///
  /// # Examples
  ///
  /// ```
